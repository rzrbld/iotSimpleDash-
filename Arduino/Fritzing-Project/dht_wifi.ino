...
//======================Configure
String backendServerIP = "176.58.108.193";                          // backend serer IP
String backendServerPort = "4000";                                  // backend server PORT
String wifiSSID = "myWiFi";                                         // WiFi SSID name
String wifiPassword = "thelongestwifipasswordontheearth";                                       // WiFi password
String arduinoUUID = "a9ad2cd7-9973-4c6a-a7a4-16002dc481a5";        // WARN! generate new before upload to arduino
